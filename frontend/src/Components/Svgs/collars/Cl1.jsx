...
const Cl1 = ({ image }) => {
  return (
    <svg
      id="be1424c9-bf67-4253-86b2-af70d256e4c0"
      data-name="Layer 2"
    ...
    >
      <defs>
        ...
        <clipPath
          id="eb945194-b94b-4363-a547-7df9a0b90faf"
          transform="translate(17.42 20.89)"
        >
          <path
            className="ae652df5-d611-4ff1-89be-80689137f8d4"
        ...
        <clipPath
          id="ad91fc89-c66d-4041-8989-d3cab8af7d5d"
          transform="translate(17.42 20.89)"
        >
          <path
            className="ae652df5-d611-4ff1-89be-80689137f8d4"
        ...
        <clipPath
          id="fe1c328f-71a7-41d1-baff-0469522633e9"
          transform="translate(17.42 20.89)"
        >
          <path
            className="ae652df5-d611-4ff1-89be-80689137f8d4"
        ...
        <image
          id="ab647f06-a5f6-421d-98d5-19f8d67b10ff"
          width="768"
          height="1024"
          xlinkHref={image}
        />
      ...
      <g className="ae2ccc90-e9a8-4d35-9b20-ce44f4c607f4">
        <use
          transform="translate(7.61) scale(0.28)"
          xlinkHref="#ab647f06-a5f6-421d-98d5-19f8d67b10ff"
        />
      </g>
      <path
        className="ae652df5-d611-4ff1-89be-80689137f8d4"
      ...
      <path
        ...
        transform="translate(17.42 20.89)"
      />
      <g className="fad2b1df-f08b-4662-b1ce-293679eaf856">
        <use
          transform="translate(-17.42 -15.2) scale(0.28)"
          xlinkHref="#ab647f06-a5f6-421d-98d5-19f8d67b10ff"
        />
      </g>
      <path
      ...
      <path
        ...
        transform="translate(17.42 20.89)"
      />
      <g className="afc6a9e0-b49e-4559-9f77-b6550e9293aa">
        <use
          transform="translate(-17.42 -15.2) scale(0.28)"
          xlinkHref="#ab647f06-a5f6-421d-98d5-19f8d67b10ff"
        />
      ...
      <path
        className="ae652df5-d611-4ff1-89be-80689137f8d4"
        d="M61.18,81.29s-3.38,12.18,0,19.51"
        transform="translate(17.42 20.89)"
      />
      <circle
        className="ae652df5-d611-4ff1-89be-80689137f8d4 btnColorChange"
        cx="83.04"
        cy="112.84"
        r="2.15"
      />
