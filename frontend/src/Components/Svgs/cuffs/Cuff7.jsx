...
const Cuff7 = ({ image }) => {
  return (
    <svg
      id="ad4df73d-9f1c-4ba5-ac60-b332c57696b5"
      data-name="Layer 1"
    ...
    >
      <defs>
        ...
        <clipPath
          id="e3642290-ba8f-48eb-bd70-d41ad47aa983"
          transform="translate(208.31 389.69)"
        >
          <path
            className="a349d5d0-cdaa-4c1e-97b4-2a145d1a4da9"
      ...
      <g className="a539640c-e4cf-4bfd-8a01-a62ca6ac1b23">
        <image
          width="768"
          height="1024"
          transform="scale(1.8)"
      ...
      />
      <path
        className="a5ad69c8-f616-414f-a3ff-3d670b37b50d"
      ...
      />
      <circle
        className="a5ad69c8-f616-414f-a3ff-3d670b37b50d btnColorChange"
        cx="358.83"
        cy="447.27"
        r="18.64"
      />
